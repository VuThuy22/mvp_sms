    ...
    private void initUI() {
        ...
        adapterSms.setOnShowDetail(new SmsAdapter.onShowDetail() {
            ...
            public void onClick(SmsBank smsBank) {
                ...
                intent.putExtra("id",smsBank.getId());
                intent.putExtra("content",smsBank.getContent());
                intent.putExtra("phone",smsBank.getPhone());
                intent.putExtra("action",smsBank.getAction());
                intent.putExtra("status",smsBank.getStatus());
                intent.putExtra("fullcontent",smsBank.getFullconte());
                intent.putExtra("account",smsBank.getAccount());
                intent.putExtra("balance",smsBank.getBalance());
                intent.putExtra("moneytrans",smsBank.getMoneytrans());
                intent.putExtra("time",smsBank.getTime());
